...
const mockEditing: EditingState = {
  ...
  stampCardOpen: false,
  setStampCardOpen: noop,
  armExhibitStamp: () => false,
  refreshArmedExhibitStamp: noop,
  disarmExhibitStamp: noop,
  allocateExhibitStampIdentifier: () => Promise.resolve(null),
  countPlacedExhibitStamps: () => 0,
  exhibitStampRenumberRequest: null,
  requestExhibitStampRenumber: noop,
  cancelExhibitStampRenumber: noop,
  renumberExhibitStamps: () => Promise.resolve(null),
  flattenOnSave: true,
