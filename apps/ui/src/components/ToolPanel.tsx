...
const TOOL_PANEL_ICONS = {
  ...
  formCheckbox: <RectangleIcon size={16} />,
  callout: <CalloutIcon size={16} />,
  ...
  shapeRect: <RectangleIcon size={16} />,
  shapeEllipse: <EllipseIcon size={16} />,
  shapeLine: <LineIcon size={16} />,
  shapeArrow: <ArrowLineIcon size={16} />,
  sign: <SignIcon size={16} />,
  stamp: <ExhibitStampIcon size={16} />,
